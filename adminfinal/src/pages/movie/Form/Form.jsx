...
const Form = () => {
  ...
  const validateForm = () => {
    const errors = [];
    if (!formData.title) errors.push("Title is a must be provided");
    if (!formData.overview) errors.push("Overview is a must be provided");
    if (!formData.releaseDate) errors.push("Release date  is a must be provided");
    if (!formData.popularity) errors.push("Popularity  is a must be provided");
    if (!formData.voteAverage) errors.push("Vote average  is a must be provided");
